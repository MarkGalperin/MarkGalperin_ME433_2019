...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_CHECK_TIMER:
            ...
            if(readonce == 1){
                if (appData.isReadComplete || _CP0_GET_COUNT() - startTime > (48000000 / 2 / 100)) { // here I changed it to 100Hz...
                    appData.state = APP_STATE_SCHEDULE_WRITE;
                }
            }
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            gposn_x = (data[9]<<8) | data[8]; 
            gposn_y = (data[11]<<8) | data[10];
            gposn_z = (data[13]<<8) | data[12];


            
            
            //SENDING TO THE COMPUTER
            len = sprintf(dataOut, "%7d %7d %7d %7d %7d %7d %7d\r\n", i,gposn_x,gposn_y,gposn_z,gyro_x,gyro_y,gyro_z);
