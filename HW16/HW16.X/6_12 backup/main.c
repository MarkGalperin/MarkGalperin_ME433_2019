...
void __ISR(16, IPL5SOFT) Timer4ISR(void) {
    ...
    OC1RS = (unsigned int) ((isr_count/100.0) * PR3);
    OC4RS = (unsigned int) ((isr_count/100.0) * PR3);
...
void startup() {
    ...
    RPB15Rbits.RPB15R = 0b0101; //mapping B15 to OC1...
    
    // OC4 is A4, goes with DIR2
    RPA4Rbits.RPA4R = 0b0101; //mapping A0 to OC4...
    ...
    pwm_init();
    pwm_active(0);
    OC1RS = (unsigned int) ((duty/100.0) * PR3);
    DIR1 = 1;
    
    //pwm2...
    pwm2_init();
    pwm2_active(0);
    OC4RS = (unsigned int) ((duty/100.0) * PR3);
    DIR2 = 0;
